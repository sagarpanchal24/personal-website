...
const photoData = {
  ...
  praha: {
    ...
    photos: [
      ...
      { src: 'assets/images/Praha/IMG_8722.JPG',        story: "Čekejte — Wait, This worn pedestrian crossing button says it plainly in Czech: wait. Behind it, the city moves anyway. A small detail most visitors walk past, but one that quietly reminds you — you are somewhere with its own language and its own rhythm." },
